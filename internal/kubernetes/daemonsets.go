...
func PrepareDaemonSetMaps(obj1, obj2 *v1.DaemonSetList) ([]AbstractPodController, map[string]IsAlreadyComparedFlag, []AbstractPodController, map[string]IsAlreadyComparedFlag) { //nolint:gocritic,unused
	var (
