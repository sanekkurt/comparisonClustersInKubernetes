...
func compareCommonProbeParams(ctx context.Context, probe1, probe2 v1.Probe) {
	var (
		...
		diffs = diff.BatchFromContext(ctx)
	)
	...
	if probe1.FailureThreshold != probe2.FailureThreshold {
		...
		diffs.Add(ctx, false, zap.WarnLevel, "%s: %s vs %s", ErrorContainerHealthCheckDifferentFailureThreshold.Error(), probe1.FailureThreshold, probe2.FailureThreshold)
	}
	...
	if probe1.InitialDelaySeconds != probe2.InitialDelaySeconds {
		...
		diffs.Add(ctx, false, zap.WarnLevel, "%s: %s vs %s", ErrorContainerHealthCheckDifferentInitialDelaySeconds.Error(), probe1.InitialDelaySeconds, probe2.InitialDelaySeconds)
	}
	...
	if probe1.PeriodSeconds != probe2.PeriodSeconds {
		...
		diffs.Add(ctx, false, zap.WarnLevel, "%s: %s vs %s", ErrorContainerHealthCheckDifferentPeriodSeconds.Error(), probe1.PeriodSeconds, probe2.PeriodSeconds)
	}
	...
	if probe1.SuccessThreshold != probe2.SuccessThreshold {
		...
		diffs.Add(ctx, false, zap.WarnLevel, "%s: %s vs %s", ErrorContainerHealthCheckDifferentSuccessThreshold.Error(), probe1.SuccessThreshold, probe2.SuccessThreshold)
	}
	...
	if probe1.TimeoutSeconds != probe2.TimeoutSeconds {
		...
		diffs.Add(ctx, false, zap.WarnLevel, "%s: %s vs %s", ErrorContainerHealthCheckDifferentTimeoutSeconds.Error(), probe1.TimeoutSeconds, probe2.TimeoutSeconds)
	}
}
