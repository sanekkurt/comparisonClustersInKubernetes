...
func compareCommonProbeParams(ctx context.Context, probe1, probe2 v1.Probe) {
	...
	if probe1.FailureThreshold != probe2.FailureThreshold {
		...
		//diffsBatch.Add(ctx, false, zap.WarnLevel, "%s: %s vs %s", ErrorContainerHealthCheckDifferentFailureThreshold.Error(), probe1.FailureThreshold, probe2.FailureThreshold)
		*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentFailureThreshold.Error(), probe1.FailureThreshold, probe2.FailureThreshold)}
	...
	if probe1.InitialDelaySeconds != probe2.InitialDelaySeconds {
		...
		*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentInitialDelaySeconds.Error(), probe1.InitialDelaySeconds, probe2.InitialDelaySeconds)}
	...
	if probe1.PeriodSeconds != probe2.PeriodSeconds {
		...
		*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentPeriodSeconds.Error(), probe1.PeriodSeconds, probe2.PeriodSeconds)}
	...
	if probe1.SuccessThreshold != probe2.SuccessThreshold {
		...
		*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentSuccessThreshold.Error(), probe1.SuccessThreshold, probe2.SuccessThreshold)}
	...
	if probe1.TimeoutSeconds != probe2.TimeoutSeconds {
		...
		*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentTimeoutSeconds.Error(), probe1.TimeoutSeconds, probe2.TimeoutSeconds)}
