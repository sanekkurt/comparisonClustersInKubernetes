...
func compareHTTPGetProbes(ctx context.Context, probe1, probe2 v1.Probe) {
	...
	if probe1.HTTPGet != nil && probe2.HTTPGet != nil {
		if probe1.HTTPGet.Host != probe2.HTTPGet.Host {
			...
			*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentHTTPGetHost.Error(), probe1.HTTPGet.Host, probe2.HTTPGet.Host)}
		...
		if probe1.HTTPGet.HTTPHeaders != nil && probe2.HTTPGet.HTTPHeaders != nil {
			if len(probe1.HTTPGet.HTTPHeaders) != len(probe2.HTTPGet.HTTPHeaders) {
				...
				*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentHTTPGetHTTPHeaders.Error(), len(probe1.HTTPGet.HTTPHeaders), len(probe2.HTTPGet.HTTPHeaders))}
			...
			for index, value := range probe1.HTTPGet.HTTPHeaders {
				if value.Name != probe2.HTTPGet.HTTPHeaders[index].Name {
					...
					*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s, %s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentHTTPGetHeaderName.Error(), index+1, probe1.HTTPGet.HTTPHeaders[index].Name, probe2.HTTPGet.HTTPHeaders[index].Name)}
				...
				if value.Value != probe2.HTTPGet.HTTPHeaders[index].Value {
					...
					*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s, %s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentHTTPGetHeaderValue.Error(), value.Name, value.Value, probe2.HTTPGet.HTTPHeaders[index].Value)}
			...
			*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckHTTPGetMissingHeader.Error(), probe1.HTTPGet.HTTPHeaders, probe2.HTTPGet.HTTPHeaders)}
		}
		...
		if probe1.HTTPGet.Path != probe2.HTTPGet.Path {
			...
			*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentHTTPGetPath.Error(), probe1.HTTPGet.Path, probe2.HTTPGet.Path)}
		}
		...
		if probe1.HTTPGet.Port.IntVal != probe2.HTTPGet.Port.IntVal ||
			...
			*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentHTTPGetPort.Error(), probe1.HTTPGet.Port, probe2.HTTPGet.Port)}
		...
		if probe1.HTTPGet.Scheme != probe2.HTTPGet.Scheme {
			...
			*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentHTTPGetScheme.Error(), probe1.HTTPGet.Scheme, probe2.HTTPGet.Scheme)}
		...
		*diffsChannel <- diff.Diff{ctx, false, zap.WarnLevel, "%s: %s vs %s", append(make([]interface{}, 0, 0), ErrorContainerHealthCheckDifferentHTTPGet.Error(), probe1.HTTPGet, probe2.HTTPGet)}
