...
func CompareVolumes(ctx context.Context, volume1, volume2 v1.Volume) error {
	...
	if volume1.Name != volume2.Name {
		...
		diffsBatch.Add(ctx, true, zap.WarnLevel, "%s: %s vs %s", ErrorVolumeDifferentNames.Error(), volume1.Name, volume2.Name)
		return nil
	}
	...
	if volume1.HostPath != nil && volume2.HostPath != nil {
		...
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorMissingHostPathVolumeSource.Error())
	}
	...
	if volume1.VolumeSource.EmptyDir != nil && volume2.VolumeSource.EmptyDir != nil {
		...
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorPodMissingVolumesEmptyDir.Error())
	}
	...
	if volume1.Secret != nil && volume2.Secret != nil {
		...
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorPodMissingVolumesSecrets.Error())
	}
	...
	if volume1.NFS != nil && volume2.NFS != nil {
		...
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorPodMissingVolumesNFS.Error())
	}
	...
	if volume1.PersistentVolumeClaim != nil && volume2.PersistentVolumeClaim != nil {
		...
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorPodMissingPersistentVolumeClaim.Error())
	}
	...
	if volume1.DownwardAPI != nil && volume2.DownwardAPI != nil {
		...
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorPodMissingVolumesDownwardAPI.Error())
	}
	...
	if volume1.VolumeSource.ConfigMap != nil && volume2.VolumeSource.ConfigMap != nil {
		...
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorPodMissingVolumesConfigMap.Error())
	}
	...
	if volume1.CSI != nil && volume2.CSI != nil {
		...
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorPodMissingVolumesCSI.Error())

	}

	if volume1.ISCSI != nil && volume2.ISCSI != nil {
		if !reflect.DeepEqual(*volume1.ISCSI, *volume2.ISCSI) {
			diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorISCSIDifferent.Error())
		}
	} else if volume1.ISCSI != nil || volume2.ISCSI != nil {
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorISCSIMissing.Error())
	}

	if volume1.CephFS != nil && volume2.CephFS != nil {
		if !reflect.DeepEqual(*volume1.CephFS, *volume2.CephFS) {
			diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorCephFSDifferent.Error())
		}
	} else if volume1.CephFS != nil || volume2.CephFS != nil {
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorCephFSMissing.Error())
	}
	...
	if volume1.GCEPersistentDisk != nil && volume2.GCEPersistentDisk != nil {
		if !reflect.DeepEqual(*volume1.GCEPersistentDisk, *volume2.GCEPersistentDisk) {
			diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorGCEPersistentDiskDifferent.Error())
		}
	} else if volume1.GCEPersistentDisk != nil || volume2.GCEPersistentDisk != nil {
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorGCEPersistentDiskMissing.Error())
	}
	...
	if volume1.PhotonPersistentDisk != nil && volume2.PhotonPersistentDisk != nil {
		if !reflect.DeepEqual(*volume1.PhotonPersistentDisk, *volume2.PhotonPersistentDisk) {
			diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorPhotonPersistentDiskDifferent.Error())
		}

	} else if volume1.PhotonPersistentDisk != nil || volume2.PhotonPersistentDisk != nil {
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorPhotonPersistentDiskMissing.Error())
	}

	if volume1.Projected != nil && volume2.Projected != nil {
		if !reflect.DeepEqual(*volume1.Projected, *volume2.Projected) {
			diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorProjectedDifferent.Error())
		}

	} else if volume1.Projected != nil || volume2.Projected != nil {
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorProjectedMissing.Error())
	}
	...
	if volume1.PortworxVolume != nil && volume2.PortworxVolume != nil {
		if !reflect.DeepEqual(*volume1.PortworxVolume, *volume2.PortworxVolume) {
			diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorPortworxVolumeDifferent.Error())
		}

	} else if volume1.PortworxVolume != nil || volume2.PortworxVolume != nil {
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorPortworxVolumeMissing.Error())
	}

	if volume1.ScaleIO != nil && volume2.ScaleIO != nil {
		if !reflect.DeepEqual(*volume1.ScaleIO, *volume2.ScaleIO) {
			diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorScaleIODifferent.Error())
		}

	} else if volume1.ScaleIO != nil || volume2.ScaleIO != nil {
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorScaleIOMissing.Error())
	}

	if volume1.StorageOS != nil && volume2.StorageOS != nil {
		if !reflect.DeepEqual(*volume1.StorageOS, *volume2.StorageOS) {
			diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorStorageOSDifferent.Error())
		}

	} else if volume1.StorageOS != nil || volume2.StorageOS != nil {
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorStorageOSMissing.Error())
	}

	if volume1.Ephemeral != nil && volume2.Ephemeral != nil {
		if !reflect.DeepEqual(*volume1.Ephemeral, *volume2.Ephemeral) {
			diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorEphemeralDifferent.Error())
		}

	} else if volume1.Ephemeral != nil || volume2.Ephemeral != nil {
		diffsBatch.Add(ctx, false, zap.WarnLevel, "%s", ErrorEphemeralMissing.Error())
	}
